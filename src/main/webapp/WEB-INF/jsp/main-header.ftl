<header class="main-header">
    ...
    <a href="${ctx}" class="logo">
        ...
        <span class="logo-mini"><b>快付</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img src="${ctx}/res/img/logo.png" alt="快付"/></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="${ctx}/res/AdminLTE/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                            <p>
                                <@shiro.principal property="username"/> - <@shiro.principal property="nickname"/>
