...
<head>
  ...
  <title>${title}</title>
    ...
    <link rel="bookmark" href="${ctx}/res/img/favicon.ico"/>
...
<!-- FastClick -->
<script src="${ctx}/res/AdminLTE/bower_components/fastclick/lib/fastclick.js"></script>
<!-- AdminLTE App -->
...
<script type="text/javascript">
    $(function () {
        //左侧菜单展示效果
        $('.sidebar-menu .active').parents('ul.treeview-menu,li.treeview').each(function(){
